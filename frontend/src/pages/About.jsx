    ...
    <div className="space-y-12">
      ...
      <div className="grid md:grid-cols-3 gap-6">
        <div className="bg-white rounded-xl p-6 shadow-card">
          ...
          <h3 className="text-xl font-bold text-text mb-2">Reliable</h3>
        ...
        <div className="bg-white rounded-xl p-6 shadow-card">
          ...
          <h3 className="text-xl font-bold text-text mb-2">Fast</h3>
          <p className="text-text-light">
        ...
        <div className="bg-white rounded-xl p-6 shadow-card">
          ...
          <h3 className="text-xl font-bold text-text mb-2">Accurate</h3>
          <p className="text-text-light">
      ...
      <div className="bg-white rounded-xl p-8 shadow-card">
        ...
        <div className="grid md:grid-cols-2 gap-8">
          <div>
            <h3 className="text-xl font-semibold text-text mb-4">Frontend</h3>
          ...
          <div>
            <h3 className="text-xl font-semibold text-text mb-4">Backend</h3>
            <ul className="space-y-2 text-text-light">
      ...
      <div className="bg-yellow-50 border border-yellow-200 rounded-xl p-6">
        <h3 className="text-lg font-bold text-yellow-900 mb-2">⚠️ Important Disclaimer</h3>
